  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
       ...
       <div class="ip">
           <input type="text" name="hnm" placeholder="your name" class="namee"> <br> <br>
           <input type="email" name="hel" placeholder="your mail" class="namee"> <br><br>
           <input type="number" name="hph" placeholder="your phone" class="namee"> <br><br>
           <input type="number" name="hgst" placeholder="no. of person" class="namee"> <br><br>
           <input type="date" name="hserv" placeholder="date" class="namee"> <br><br>
  <label for="">From</label><input type="time" name="hof" placeholder="time" class="namee"> <label for="">To</label> <input type="time" name="hto" placeholder="time" class="namee"> <br><br>
           <input type="text" name="hcomm" placeholder="your comment" class="namee"> <br><br>
       </div>
       <button type="submit" name="reg" > BookNow</button>
   </form> 
