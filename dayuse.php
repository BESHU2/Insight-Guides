...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <div class="ip">
           ...
           <label for="">FullName</label><input type="text" name="dnm" placeholder="your name" class="namee" required> <br> <br>
           <label for="">Email</label><input type="email" name="del" placeholder="your mail" class="namee" required> <br><br>
           <label for="">Phone</label><input type="number" name="dph" placeholder="your phone" class="namee" required> <br><br>
           <label for="">Reservation</label><input type="number" name="dgst" placeholder="no. of person" class="namee" required> <br><br>
           <label for="">Date</label><input type="date" name="dserv" placeholder="date" class="namee" required> <br><br>
  <label for="">From</label><input type="time" name="dof" placeholder="time" class="namee" required> <br> <br> 
  <label for="">To</label> <input type="time" name="dto" placeholder="time" class="namee" required> <br><br>
  <label for=""> Any requests</label><input type="text" name="dcomm" placeholder="your comment" class="namee" > <br><br> <hr>
  <label for="">Choose Restaurant</label> <select name="dchoice" id="">
  ...
  <style>
    ...
    <div class="content">
      ...
      <section class="acc1">
        <label for="">CARD NUMBER</label> <input type="password" placeholder="Valid Card Number" name="dcr1"> <br> <br>
        <label for="">Expiration Date</label> <input type="date" placeholder="MM/YY"  name="dcr2"> <label for="">CVV</label> <input type="password" placeholder="CVV"  name="dcr3"> <br> <br>
        <label for="">Holder Name</label> <input type="text" placeholder="Your Name"  name="dcr4">
        <style>
          .content input{
            border-radius: 6px;
            color: black;
       ...
       <button type="submit" name="done" class="btn btn-secondary"> Book Now</button>
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <label for="">FullName</label><input type="text" name="dnm" placeholder="your name" class="namee" required> <br> <br>
           ...
           <label for="">Reservation</label><input type="number" name="dgst" placeholder="no. of person" class="namee" required> <br><br>
           <label for="">Date</label><input type="date" name="dserv" placeholder="date" class="namee" required> <br><br>
  <label for="">From</label><input type="time" name="dof" placeholder="time" class="namee" required> 
  <label for="">To</label> <input type="time" name="dto" placeholder="time" class="namee" required> <br><br>
  <label for=""> Any requests</label><input type="text" name="dcomm" placeholder="your comment" class="namee"> <br><br>
       </div>
       <button type="submit" name="done" > Book Now</button>
       <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
   </form> 
    ...
    <div class="modal-content" style="height: 0%;">
      <style>
       ...
       <div class="ip">
        ...
        <input type="text" name="dnm" placeholder="your name" class="namee"> <br> <br>
          <label for="">Email</label>         
          <input type="email" name="del" placeholder="your mail" class="namee"> <br><br>
          <label for="">Phone</label>
           <input type="number" name="dph" placeholder="your phone" class="namee"> <br><br>
           <label for="">Reservation</label>
           <input type="number" name="dgst" placeholder="no. of person" class="namee"> <br><br>
           <label for="">Date</label>
           <input type="date" name="dserv" placeholder="date" class="namee"> <br><br>
  <label for="">From</label><input type="time" name="dof" placeholder="time" class="namee"> 
  <label for="">To</label> <input type="time" name="dto" placeholder="time" class="namee"> <br><br>
  <label for=""> Any requests</label><input type="text" name="dcomm" placeholder="your comment" class="namee"> <br><br>
       </div>
       <button type="submit" name="done" class="bttnn"  > Book Now</button>
       <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
   </form> 
