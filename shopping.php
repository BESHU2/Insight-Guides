    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <div class="ip">
           ...
           <input type="text" name="snm" placeholder="your name" class="namee"> <br> <br>
           <input type="email" name="sel" placeholder="your mail" class="namee"> <br><br>
           <input type="number" name="sph" placeholder="your phone" class="namee"> <br><br>
           <input type="number" name="sgst" placeholder="no. of person" class="namee"> <br><br>
           <input type="date" name="sserv" placeholder="date" class="namee"> <br><br>
  <label for="">From</label><input type="time" name="sof" placeholder="time" class="namee"> <label for="">To</label> <input type="time" name="sto" placeholder="time" class="namee"> <br><br>
           <input type="text" name="scomm" placeholder="your comment" class="namee"> <br><br>
       </div>
       <button type="submit" name="edt" > BookNow</button>
   </form> 
