...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <div class="ip">
           ...
           <label for="">FullName</label><input type="text" name="rnm" placeholder="your name" class="namee" required> <br> <br>
           <label for="">Email</label><input type="email" name="rel" placeholder="your mail" class="namee" required> <br><br>
           <label for="">Phone</label><input type="number" name="rph" placeholder="your phone" class="namee" required> <br><br>
           <label for="">Reservation</label><input type="number" name="rgst" placeholder="no. of person" class="namee" required> <br><br>
           <label for="">Date</label><input type="date" name="rserv" placeholder="date" class="namee" required> <br><br>
  <label for="">From</label><input type="time" name="rof" placeholder="time" class="namee" required> <br> <br> 
  <label for="">To</label> <input type="time" name="rto" placeholder="time" class="namee" required> <br><br>
  <label for=""> Any requests</label><input type="text" name="rcomm" placeholder="your comment" class="namee" > <br><br> <hr>
  <label for="">Choose Restaurant</label> <select name="choice" id="">
    <option value="Mori Sushi">Mori Sushi</option>
  ...
  <style>
    ...
    <div class="content">
      ...
      <section class="acc1">
        <label for="">CARD NUMBER</label> <input type="password" placeholder="Valid Card Number" name="cr1"> <br> <br>
        <label for="">Expiration Date</label> <input type="date" placeholder="MM/YY"  name="cr2"> <label for="">CVV</label> <input type="password" placeholder="CVV"  name="cr3"> <br> <br>
        <label for="">Holder Name</label> <input type="text" placeholder="Your Name"  name="cr4">
        <style>
          .content input{
            border-radius: 6px;
            color: black;
       ...
       <button type="submit" name="booknow" class="btn btn-secondary"> Book Now</button>
    ...
    <div class="modal-content">
      <div class="modal-header">
       ...
       <label for="">FullName</label><input type="text" name="rnm" placeholder="your name" class="namee" required> <br> <br>
           ...
           <label for="">Reservation</label><input type="number" name="rgst" placeholder="no. of person" class="namee" required> <br><br>
           <label for="">Date</label><input type="date" name="rserv" placeholder="date" class="namee" required> <br><br>
  <label for="">From</label><input type="time" name="rof" placeholder="time" class="namee" required> 
  <label for="">To</label> <input type="time" name="rto" placeholder="time" class="namee" required> <br><br>
  <label for=""> Any requests</label><input type="text" name="rcomm" placeholder="your comment" class="namee"> <br><br>
       </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <label for="">From</label><input type="time" name="rof" placeholder="time" class="namee"> 
  <label for="">To</label> <input type="time" name="rto" placeholder="time" class="namee"> <br><br>
  <label for=""> Any requests</label><input type="text" name="rcomm" placeholder="your comment" class="namee"> <br><br>
       </div>
...
<div class="row">
  <div  class="col-sm-3" id="loll"  >
  <figure> <img src="images/restaurant/joia.jpg" width="250px" height="250px" alt="" ></figure>
<figcaption> <h1>Joia Sushi</h1> Phone :1117297401<br> Location : 22, Nabil Al Wakkad, Al Golf, Nasr City Cairo, Cairo  <br> <br> 
<!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
book now
</button>
...
<div  class="col-sm-3" id="loll"  >
<figure> <img src="images/restaurant/mince.jpg" width="250px" height="250px" alt="" ></figure>
<figcaption> <h1>Mince</h1> Phone : 16885<br> Location :City Stars/Point 90 Cairo <br> <br> 
<!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
Book Now
</button>
...
<div  class="col-sm-3" id="loll"  >
<figure> <img src="images/restaurant/stero.jpg" width="250px" height="250px" alt="" ></figure>
<figcaption> <h1>Stereo Restaurant & Cafe</h1> Phone :19706<br> Location : Street 66 from 90th st., Fifth Settlement <br> 
<!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
Book Now
</button>
